...
/**
 * SingleUser 
 * -Represents the Leaf of the Composite design pattern.
 * -Represents both Subject and Observer of Observer design pattern.
 * -Accepts visitors of Visitor design pattern.
